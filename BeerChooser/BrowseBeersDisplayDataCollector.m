...
{
    return [BrowseBeersDisplayItem browseBeersDisplayItemWithName:browseBeer.beerName brewery:browseBeer.brewery numBeers:browseBeer.numBeers isRated:browseBeer.isRated];
}
